...
export const metadata: Metadata = {
  title: "Pasta Paradise - Taste the Tradition",
  description: "Experience the finest pasta dishes crafted with love and authenticity at Pasta Paradise.",
  openGraph: {
    title: "Pasta Paradise - Taste the Tradition",
    description: "Experience the finest pasta dishes crafted with love and authenticity at Pasta Paradise.",
    url: "", // Add your canonical URL here if available
    siteName: "Pasta Paradise",
  },
  twitter: {
